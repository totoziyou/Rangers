...
var ClubLayer = cc.Layer.extend({
    ctor:function () {
        ...
        this.bg=cc.Sprite.create(res.club.bg);
        ...
        this.npc=cc.Sprite.create(res.npc.club);
        this.npc.attr({x:100*rm,y:0,scale:rm,anchorX:0,anchorY:0});
...
var ClubScene = cc.Scene.extend({
    onEnter:function () {
        this._super();
        var layer = new ClubLayer();
        this.addChild(layer);
    }
});

xLayer.Club=ClubLayer;
xScene.Club=ClubScene;