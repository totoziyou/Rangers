...
var MysteryShopLayer = cc.Layer.extend({
    ctor:function () {
        ...
        this.npc=cc.Sprite.create(res.npc.mysteryShop);
...
var MysteryShopScene = cc.Scene.extend({
    onEnter:function () {
        this._super();
        var layer = new MysteryShopLayer();
        this.addChild(layer);
    }
});

xLayer.MysteryShop=MysteryShopLayer;
xScene.MysteryShop=MysteryShopScene;