...
var WeaponShopLayer = cc.Layer.extend({
    ctor:function () {
...
var WeaponShopScene = cc.Scene.extend({
    onEnter:function () {
        this._super();
        var layer = new WeaponShopLayer();
        this.addChild(layer);
    }
});

xLayer.WeaponShop=WeaponShopLayer;
xScene.WeaponShop=WeaponShopScene;